...
public class RoboMap {
	...
	public static final double PID_WHITE_SETPOINT  = 140; // Needs calibration -- Works (test map)
	public static final double PID_YELLOW_SETPOINT = 73; // Needs calibration -- Works (test map)
